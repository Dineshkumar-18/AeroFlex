...
namespace AeroFlex.Migrations
{
    ...
    [Migration("20241003023647_flightschedulelayout")]
    partial class flightschedulelayout
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AeroFlex.Models.FlightScheduleLayout", b =>
                {
                    ...
                    b.ToTable("FlightScheduleLayouts");
                });

            modelBuilder.Entity("AeroFlex.Models.FlightScheduleUnavailableSeats", b =>
                {
                    ...
                    b.ToTable("FlightScheduleUnavailableSeats");
                });
            ...
            modelBuilder.Entity("AeroFlex.Models.FlightScheduleLayout", b =>
                {
                    b.HasOne("AeroFlex.Models.FlightSchedule", null)
                        .WithMany("FlightScheduleLayouts")
                        .HasForeignKey("FlightScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AeroFlex.Models.FlightScheduleUnavailableSeats", b =>
                {
                    b.HasOne("AeroFlex.Models.FlightSchedule", "FlightSchedule")
                        .WithMany("FlightScheduleUnavailableSeats")
                        .HasForeignKey("FlightScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AeroFlex.Models.FlightSchedule", b =>
                {
                    ...
                    b.Navigation("FlightScheduleLayouts");

                    b.Navigation("FlightScheduleUnavailableSeats");
